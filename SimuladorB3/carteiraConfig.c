...
bool cria_carteira( carteira **carteiraOrganizada ){
    FILE *dadosGerais = fopen( "arquivos/dadosConfig.txt", "r" );
...
bool recupera_historico_de_transacao( movimentacao **carteiraInicio ){
    ...
    FILE *carteiraUsuario = fopen( "arquivos/historicoTransacao.txt", "r" ),
         *dadosGerais = fopen( "arquivos/dadosConfig.txt", "r" );
...
bool salva_carteira( carteira *carteiraInicio ){
    ...
    FILE *CARTEIRA = fopen( "arquivos/carteiraConfig.txt", "w" ),
         *dadosGerais = fopen( "arquivos/dadosConfig.txt", "w" );
...
bool recupera_carteira( carteira **inicioCarteira ){
    ...
    FILE *CARTEIRA = fopen( "arquivos/carteiraConfig.txt", "r" ),
         *dadosGerais = fopen( "arquivos/dadosConfig.txt", "r" );
